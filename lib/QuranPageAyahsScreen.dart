...
class QuranPageAyahsScreenState extends State<QuranPageAyahsScreen> {
  ...
  void playayah(audio) async{

    final directory = await getApplicationDocumentsDirectory();
    String localPath = "${directory.path}/ab/01/$audio.mp3";
          ...
          IconButton(
            ...
            onPressed: (){
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder:(context)=> QuranPageScreen(widget.mypage.surah_id+1),
                ),
              );
      ...
      body: Column(
          ...
          child: Card(
            child:Padding(
              ...
              child:new Text('${widget.mypage.surah_id.toString()}-${widget.mypage.number.toString()}- ${widget.mypage.title}')
            )
          )
              )
            ]
    ...
    return ListView.builder(
      ...
      itemBuilder: (BuildContext context, int position) {
        return Container(
            ...
            child: new InkWell(
            onTap: () {
         playayah(this.ayahList[position].audio.toString());
        },
